...
class HeapAudioBuffer {
  ...
  /**
   * Returns the base address of the allocated memory space in the WASM heap for
   * the given channel
   *
   * @param  {number} channelIndex Channel index.
   * @return {?number} WASM Heap address.
   */
  getHeapAddress(channelIndex) {
    if (channelIndex >= this._channelCount || channelIndex === 'undefined') {
      return null;
    }
    return this._dataPtr + this._length * BYTES_PER_SAMPLE * channelIndex;
  }
  /**
